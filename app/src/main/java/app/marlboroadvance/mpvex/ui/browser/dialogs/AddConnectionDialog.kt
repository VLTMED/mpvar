  ...
  AlertDialog(
    ...
    text = {
      ...
      // Name and Protocol in one row
            Row(
              ...
              OutlinedTextField(
                ...
                label = { Text("الاسم", maxLines = 1, overflow = TextOverflow.Ellipsis) },
              ...
              ExposedDropdownMenuBox(
                ...
                OutlinedTextField(
                  ...
                  onValueChange = { },
                  readOnly = true,
                  label = { Text("البروتوكول", maxLines = 1, overflow = TextOverflow.Ellipsis) },
      ...
      OutlinedTextField(
        ...
        label = { Text("المضيف/عنوان IP", maxLines = 1, overflow = TextOverflow.Ellipsis) },
        modifier = Modifier.fillMaxWidth(),
        singleLine = true,
      ...
      // Port and Path in one row
            Row(
              ...
              OutlinedTextField(
                ...
                label = { Text("المنفذ", maxLines = 1, overflow = TextOverflow.Ellipsis) },
              ...
              OutlinedTextField(
                ...
                label = { Text("المسار", maxLines = 1, overflow = TextOverflow.Ellipsis) },
      ...
      // Username and Password in one row
            Row(
              ...
              OutlinedTextField(
                ...
                label = { Text("اسم المستخدم", maxLines = 1, overflow = TextOverflow.Ellipsis) },
                modifier = Modifier.weight(0.50f),
                singleLine = true,
                enabled = !isAnonymous,
              )
              ...
              OutlinedTextField(
                ...
                label = { Text("كلمة المرور", maxLines = 1, overflow = TextOverflow.Ellipsis) },
                modifier = Modifier.weight(0.50f),
                singleLine = true,
                enabled = !isAnonymous,
              )
