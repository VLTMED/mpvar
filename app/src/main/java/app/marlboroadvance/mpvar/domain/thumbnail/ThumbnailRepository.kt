package app.marlboroadvance.mpvar.domain.thumbnail
...
class ThumbnailRepository(
  ...
  private val appearancePreferences by lazy { 
    org.koin.java.KoinJavaComponent.get<app.marlboroadvance.mpvar.preferences.AppearancePreferences>(
      app.marlboroadvance.mpvar.preferences.AppearancePreferences::class.java
    ) 
  }
