...
import app.marlboroadvance.mpvar.ui.player.controls.components.panels.SubtitlesBorderStyle
...
class SubtitlesPreferences(
  ...
  val wyzieLanguages = preferenceStore.getStringSet("wyzie_languages", setOf("all"))
