...
package app.marlboroadvance.mpvar.ui.browser.states
...
fun PermissionDeniedState(
  ...
  Box(
    ...
    Surface(
      ...
      Column(
        ...
        // Title
        Text(
          text = stringResource(R.string.permission_storage_access_required),
            ...
            Text(
              text = if (isPlayStoreBuild) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                  stringResource(R.string.permission_photos_videos_required)
                } else {
                  stringResource(R.string.permission_storage_required)
                }
              } else {
                stringResource(R.string.permission_all_files_required)
              },
        ...
        TextButton(
          ...
          Text(
            text = stringResource(R.string.permission_why_see_this),
  ...
  if (showExplanationDialog) {
    ...
    AlertDialog(
      ...
      title = {
        Text(
          text = stringResource(R.string.permission_why_needed_title),
      ...
      text = {
        Column(
          ...
          if (isPlayStoreBuild) {
            ...
            Text(
              text = stringResource(R.string.permission_needs_access),
              style = MaterialTheme.typography.bodyMedium,
            ...
            Text(
              text = stringResource(R.string.permission_android11_policy_change),
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          ...
          Text(
            text = stringResource(R.string.permission_open_source_info),
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
