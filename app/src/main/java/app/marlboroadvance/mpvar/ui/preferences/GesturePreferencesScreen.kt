...
import app.marlboroadvance.mpvar.ui.player.CustomKeyCodes
      ...
      ProvidePreferenceLocals {
        LazyColumn(
          ...
          if (showCustomSeekDialog) {
            AlertDialog(
              ...
              text = {
                Column {
                  Text(
                    text = stringResource(R.string.gesture_custom_seek_hint),
          ...
          ListPreference(
            ...
            title = { Text(text = stringResource(R.string.gesture_double_tap_area_width_title2)) },
            summary = {
              Text(
                text = stringResource(R.string.gesture_current_width, doubleTapSeekAreaWidth),
                color = MaterialTheme.colorScheme.outline,
              )
            },
          )
