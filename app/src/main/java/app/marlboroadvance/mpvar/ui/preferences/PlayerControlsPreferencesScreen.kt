...
import app.marlboroadvance.mpvar.preferences.SeekbarStyle
              ...
              AlertDialog(
                ...
                text = {
                  Column(
                    ...
                    Text(
                      text = stringResource(R.string.player_controls_custom_hide_time_hint),
                      modifier = Modifier.padding(bottom = 8.dp),
                    )
                    OutlinedTextField(
                      value = customTimeValue,
                      onValueChange = { customTimeValue = it },
                      label = { Text(stringResource(R.string.player_controls_milliseconds_label)) },
