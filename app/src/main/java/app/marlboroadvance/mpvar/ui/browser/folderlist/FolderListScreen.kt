package app.marlboroadvance.mpvar.ui.browser.folderlist
...
import app.marlboroadvance.mpvar.preferences.FolderSortType
import app.marlboroadvance.mpvar.preferences.FolderViewMode
...
import app.marlboroadvance.mpvar.preferences.SortOrder
...
import app.marlboroadvance.mpvar.ui.browser.LocalNavigationBarHeight
...
import app.marlboroadvance.mpvar.ui.browser.dialogs.GridColumnSelector
...
import app.marlboroadvance.mpvar.ui.browser.filesystem.FileSystemDirectoryScreen
import app.marlboroadvance.mpvar.ui.browser.filesystem.FileSystemBrowserRootScreen
...
import app.marlboroadvance.mpvar.ui.browser.states.LoadingState
...
import app.marlboroadvance.mpvar.utils.sort.SortUtils
...
object FolderListScreen : Screen {
  ...
  private fun MediaStoreFolderListContent() {
    ...
    val advancedPreferences = koinInject<app.marlboroadvance.mpvar.preferences.AdvancedPreferences>()
  ...
  val folderGridColumns = if (isLandscape) folderGridColumnsLandscape else folderGridColumnsPortrait
    ...
    val selectionManager = rememberSelectionManager(
      ...
      onDeleteItems = { folders, _ ->
        ...
        val videos = app.marlboroadvance.mpvar.repository.MediaFileRepository.getVideosForBuckets(context, ids)
    ...
    LaunchedEffect(permissionState.status) {
      app.marlboroadvance.mpvar.ui.browser.MainScreen.updatePermissionState(
    ...
    Scaffold(
      topBar = {
        if (isSearching) {
          ...
          BrowserTopBar(
            title = stringResource(app.marlboroadvance.mpvar.R.string.app_name),
            ...
            onShareClick = {
              coroutineScope.launch {
                ...
                val allVideos = app.marlboroadvance.mpvar.repository.MediaFileRepository
            ...
            onBlacklistClick = {
              coroutineScope.launch {
                ...
                android.widget.Toast.makeText(
                  context,
                  context.getString(app.marlboroadvance.mpvar.R.string.pref_folders_blacklisted),
            ...
            TooltipBox(
              ...
              ToggleFloatingActionButton(
                modifier = Modifier.animateFloatingActionButton(
                  visible = !selectionManager.isInSelectionMode && isFabVisible.value && !app.marlboroadvance.mpvar.ui.browser.MainScreen.getPermissionDeniedState(),
                ...
                if (isSearchLoading) {
                  ...
                  SearchResultsContent(
                    ...
                    onFolderClick = { folder ->
                      backstack.add(app.marlboroadvance.mpvar.ui.browser.videolist.VideoListScreen(folder.bucketId, folder.name))
                    },
                    onVideoClick = { video ->
...
private fun FolderListContent(
  ...
  foldersWithNewCount: List<app.marlboroadvance.mpvar.ui.browser.folderlist.FolderWithNewCount>,
  ...
  selectionManager: app.marlboroadvance.mpvar.ui.browser.selection.SelectionManager<VideoFolder, String>,
...
private fun SearchResultsContent(
  ...
  navigationBarHeight: androidx.compose.ui.unit.Dp,
  onFolderClick: (app.marlboroadvance.mpvar.domain.media.model.VideoFolder) -> Unit,
  onVideoClick: (app.marlboroadvance.mpvar.domain.media.model.Video) -> Unit,
  mediaLayoutMode: app.marlboroadvance.mpvar.preferences.MediaLayoutMode,
  folderGridColumns: Int,
) {
  val folders = searchResults.filterIsInstance<FileSystemItem.Folder>().map { folder ->
    app.marlboroadvance.mpvar.domain.media.model.VideoFolder(
  ...
  val isGridMode = mediaLayoutMode == app.marlboroadvance.mpvar.preferences.MediaLayoutMode.GRID
...
private suspend fun searchFoldersAndVideos(
  ...
  try {
    ...
    val folders = app.marlboroadvance.mpvar.repository.MediaFileRepository
    ...
    folders.forEach { folder ->
      ...
      val videos = app.marlboroadvance.mpvar.repository.MediaFileRepository
