...
import app.marlboroadvance.mpvar.preferences.preference.Preference
...
import app.marlboroadvance.mpvar.ui.preferences.components.PlayerButtonChip
        ...
        TopAppBar(
          ...
          actions = {
            IconButton(onClick = { showResetDialog = true }) {
              Icon(Icons.Outlined.Restore, contentDescription = stringResource(R.string.cd_reset_default))
            }
          },
        )
      },
        ...
        LazyVerticalGrid(
            ...
            item(span = { GridItemSpan(maxLineSpan) }) {
              androidx.compose.material3.Text(
                      text = stringResource(R.string.control_layout_long_press_reorder),
                 ...
                 item(span = { GridItemSpan(maxLineSpan) }) {
                     androidx.compose.material3.Surface(
                         ...
                         androidx.compose.foundation.layout.Column(
                             ...
                             androidx.compose.material3.Text(
                                  text = stringResource(R.string.control_layout_tap_available_palette),
                     ...
                     FlowRow(
                        ...
                        if (availableButtons.isEmpty()) {
                            androidx.compose.foundation.layout.Box(
                                ...
                                androidx.compose.material3.Text(
                                    text = stringResource(R.string.control_layout_all_buttons_in_use),
                                    style = MaterialTheme.typography.bodySmall,
                                    color = MaterialTheme.colorScheme.onSurfaceVariant
                                )
                            }
...
private fun IconsLegend() {
    androidx.compose.material3.Card(
        ...
        androidx.compose.foundation.layout.Column(
            ...
            // Header
            Text(
                text = stringResource(R.string.control_layout_icons_legend),
            ...
            FlowRow(
                ...
                allPlayerButtons.forEach { button ->
                    androidx.compose.foundation.layout.Row(
                        ...
                        Text(
                            text = app.marlboroadvance.mpvar.preferences.getPlayerButtonLabel(button),
