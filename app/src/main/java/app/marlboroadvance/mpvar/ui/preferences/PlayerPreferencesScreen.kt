...
import app.marlboroadvance.mpvar.ui.player.PlayerOrientation
          ...
          item {
            PreferenceCard {
              ...
              SwitchPreference(
                ...
                title = { Text(text = stringResource(R.string.pref_player_autoplay_next_video_title2)) },
                summary = {
                  Text(
              ...
              SwitchPreference(
                ...
                title = { Text(text = stringResource(R.string.pref_player_enable_next_prev_nav)) },
                summary = {
                  Text(
              ...
              SwitchPreference(
                ...
                title = { Text(stringResource(R.string.pref_player_dynamic_speed_overlay_title2)) },
                summary = {
                  Text(
                    text = stringResource(R.string.pref_player_auto_pip_desc),
                    color = MaterialTheme.colorScheme.outline,
                  )
                },
              )
              ...
              SwitchPreference(
                ...
                title = { Text(stringResource(R.string.pref_player_keep_screen_on_paused)) },
                summary = {
                  Text(
          ...
          item {
            PreferenceCard {
              ...
              SwitchPreference(
                ...
                title = { Text(stringResource(R.string.pref_player_show_nav_bar)) },
              )
