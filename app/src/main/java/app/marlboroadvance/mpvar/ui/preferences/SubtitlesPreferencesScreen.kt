...
import app.marlboroadvance.mpvar.repository.wyzie.WyzieEncodings
import app.marlboroadvance.mpvar.repository.wyzie.WyzieFormats
import app.marlboroadvance.mpvar.repository.wyzie.WyzieSources
...
import app.marlboroadvance.mpvar.utils.media.CustomFontEntry
import app.marlboroadvance.mpvar.utils.media.copyFontsFromDirectory
import app.marlboroadvance.mpvar.utils.media.loadCustomFontEntries
...
import app.marlboroadvance.mpvar.repository.wyzie.WyzieLanguages
          ...
          item {
            PreferenceCard {
              ...
              TextFieldPreference(
                  ...
                  textToValue = { it },
                  title = { Text(stringResource(R.string.pref_subtitles_tmdb_api_key)) },
                  summary = {
              ...
              MultiChoicePreference(
                title = { Text(stringResource(R.string.pref_subtitles_sources_title)) },
                summary = {
              ...
              // Languages (Wyzie-specific — empty = all languages)
              val wyzieLanguages by preferences.wyzieLanguages.collectAsState()
              MultiChoicePreference(
                title = { Text("لغة البحث في Wyzie") },
                summary = {
                  val summaryText = if (wyzieLanguages.isEmpty() || wyzieLanguages.contains("all")) {
                    "كل اللغات (افتراضي)"
                  } else {
                    wyzieLanguages.mapNotNull { WyzieLanguages.ALL[it] }.joinToString(", ")
                  }
                  Text(summaryText, color = MaterialTheme.colorScheme.outline)
                },
                values = WyzieLanguages.SORTED,
                selectedValues = wyzieLanguages,
                onValuesChange = { preferences.wyzieLanguages.set(it) },
                hasAllOption = true
              )
              ...
              Column(modifier = Modifier.fillMaxWidth()) {
                Row(
                  ...
                  Text(
                    text = stringResource(R.string.pref_subtitles_advanced_filters),
                ...
                if (showAdvanced) {
                  Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                    SwitchPreference(
                      ...
                      title = { Text(stringResource(R.string.pref_subtitles_hearing_impaired)) },
                    ...
                    MultiChoicePreference(
                      title = { Text(stringResource(R.string.pref_subtitles_preferred_formats)) },
                      summary = {
                    ...
                    MultiChoicePreference(
                      title = { Text(stringResource(R.string.pref_subtitles_preferred_encodings)) },
                      summary = {
              ...
              Row(
                ...
                Text(
                  text = stringResource(R.string.pref_subtitles_provided_by),
                  style = MaterialTheme.typography.bodySmall,
                  color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Text(
