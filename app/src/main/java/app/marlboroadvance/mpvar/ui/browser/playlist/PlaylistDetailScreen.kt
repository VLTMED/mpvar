...
import app.marlboroadvance.mpvar.ui.browser.cards.M3UVideoCard
...
private fun PlaylistVideoListContent(
  ...
  isLoading: Boolean,
  selectionManager: app.marlboroadvance.mpvar.ui.browser.selection.SelectionManager<PlaylistVideoItem, Int>,
