package app.marlboroadvance.mpvar.ui.browser.networkstreaming.proxy

import android.util.Log
import app.marlboroadvance.mpvar.domain.network.NetworkConnection
import app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.NetworkClient
import app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.NetworkClientFactory
    ...
    return runBlocking {
      try {
        when (streamInfo.client) {
          is app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.SmbClient -> {
            getFileSizeSMB(streamInfo)
          }

          is app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.FtpClient -> {
            getFileSizeFTP(streamInfo)
          }

          is app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.WebDavClient -> {
            val webDavClient =
              streamInfo.client as app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.WebDavClient
            ...
            val ftpClient =
              streamInfo.client as? app.marlboroadvance.mpvar.ui.browser.networkstreaming.clients.FtpClient
