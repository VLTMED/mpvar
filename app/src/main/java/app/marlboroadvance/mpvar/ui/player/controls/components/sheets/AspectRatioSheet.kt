...
private fun AddCustomRatioRow(
  ...
  Column(
    ...
    Text(
      text = stringResource(R.string.aspect_ratio_add_custom),
      style = MaterialTheme.typography.titleSmall,
    ...
    Row(
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.aspect_ratio_width_label)) },
      ...
      OutlinedTextField(
        ...
        label = { Text(stringResource(R.string.aspect_ratio_height_label)) },
        isError = errorMessage != null,
        keyboardOptions =
          KeyboardOptions(
            keyboardType = KeyboardType.Decimal,
