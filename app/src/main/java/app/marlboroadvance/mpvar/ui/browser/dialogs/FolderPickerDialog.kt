  ...
  AlertDialog(
    ...
    title = {
      Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
        Text(
          text = stringResource(R.string.folder_picker_select_folder),
        ...
        if (isSameAsSource) {
          Text(
            text = stringResource(R.string.folder_picker_cannot_select_same),
            style = MaterialTheme.typography.bodyMedium,
            fontWeight = FontWeight.Bold,
        ...
        Row(
          ...
          FilledTonalIconButton(
            ...
            Icon(
              ...
              contentDescription = stringResource(R.string.cd_internal_storage),
            )
          }
        ...
        LazyColumn(
          ...
          if (showStorageRoot) {
            ...
            if (folders.isEmpty()) {
              item {
                Text(
                  text = stringResource(R.string.folder_picker_no_subfolders),
                  style = MaterialTheme.typography.bodyLarge,
                  fontWeight = FontWeight.Medium,
                  color = MaterialTheme.colorScheme.onSurfaceVariant,
                  modifier = Modifier.padding(16.dp),
