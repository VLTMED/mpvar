...
export function FeaturesSection() {
  return (
    <section
      ...
      dir="rtl"
    >
      <div className="absolute inset-0 bg-grid-black/[0.02] dark:bg-grid-white/[0.02] pointer-events-none" style={{ backgroundSize: "32px 32px" }} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <motion.div
              ...
              className="feature-card relative overflow-hidden bg-foreground/[0.03] dark:bg-white/[0.02] backdrop-blur-md border border-foreground/5 dark:border-white/5 rounded-3xl p-8 hover:bg-foreground/5 dark:hover:bg-white/[0.04] hover:border-primary/30 transition-all duration-300 cursor-pointer group flex flex-col items-center text-center"
            >
