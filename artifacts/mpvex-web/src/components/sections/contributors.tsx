...
import { type GitHubContributor, getRepositoryContributors } from "@/lib/github";
    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2
            className="text-4xl sm:text-5xl text-foreground mb-4 text-balance"
            style={{
          ...
          >
            أشخاص رائعون يجعلون mpvExtended أفضل كل يوم
          </p>
        </div>
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <div
              ...
              style={{ fontFamily: "'ThmanyahSans', system-ui, sans-serif", fontWeight: 400 }}
            >
              جارٍ تحميل المساهمين...
            </div>
          </div>
        ) : (
              ...
              >
                <div className="bg-background border border-border rounded-2xl p-6 flex flex-col items-center gap-4 hover:border-primary transition-all duration-300 h-full">
                  <div className="relative w-16 h-16 rounded-full border-2 border-primary group-hover:scale-110 transition-transform duration-300 overflow-hidden">
                    <img
                      src={contributor.avatar_url || "/icon.png"}
                  ...
                  <div className="text-center grow">
                    <p
                      className="text-foreground text-sm line-clamp-2"
                    ...
                    >
                      {contributor.contributions} إسهام
                    </p>
                  </div>
