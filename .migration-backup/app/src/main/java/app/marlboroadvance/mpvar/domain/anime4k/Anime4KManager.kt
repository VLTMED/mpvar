...
class Anime4KManager(private val context: Context) {
  ...
  enum class Quality(val suffix: String, val titleRes: Int) {
    FAST("S", app.marlboroadvance.mpvar.R.string.anime4k_quality_fast),
    BALANCED("M", app.marlboroadvance.mpvar.R.string.anime4k_quality_balanced),
    HIGH("L", app.marlboroadvance.mpvar.R.string.anime4k_quality_high)
  }

  // Anime4K modes
  enum class Mode(val titleRes: Int) {
    OFF(app.marlboroadvance.mpvar.R.string.anime4k_mode_off),
    A(app.marlboroadvance.mpvar.R.string.anime4k_mode_a),
    B(app.marlboroadvance.mpvar.R.string.anime4k_mode_b),
    C(app.marlboroadvance.mpvar.R.string.anime4k_mode_c),
    A_PLUS(app.marlboroadvance.mpvar.R.string.anime4k_mode_a_plus),
    B_PLUS(app.marlboroadvance.mpvar.R.string.anime4k_mode_b_plus),
    C_PLUS(app.marlboroadvance.mpvar.R.string.anime4k_mode_c_plus)
  }
