...
import app.marlboroadvance.mpvar.domain.network.NetworkFile
...
import app.marlboroadvance.mpvar.ui.browser.cards.NetworkFolderCard
import app.marlboroadvance.mpvar.ui.browser.cards.NetworkVideoCard
    ...
    files.isEmpty() -> {
      Box(
        ...
        EmptyState(
          icon = Icons.Filled.Folder,
          title = "مجلد فارغ",
          message = "لا يحتوي هذا المجلد على ملفات أو دلائل",
        )
      }
    }
