...
import app.marlboroadvance.mpvar.ui.player.Decoder
import app.marlboroadvance.mpvar.ui.player.Panels
import app.marlboroadvance.mpvar.ui.player.Sheets
import app.marlboroadvance.mpvar.ui.player.TrackNode
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.AspectRatioSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.AudioTracksSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.ChaptersSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.DecodersSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.FrameNavigationSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.MoreSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.PlaybackSpeedSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.PlaylistSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.SubtitlesSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.OnlineSubtitleSearchSheet
import app.marlboroadvance.mpvar.ui.player.controls.components.sheets.VideoZoomSheet
...
fun PlayerSheets(
  sheetShown: Sheets,
  viewModel: app.marlboroadvance.mpvar.ui.player.PlayerViewModel,
  // subtitles sheet
  ...
  when (sheetShown) {
    ...
    Sheets.SubtitleTracks -> {
      ...
      val subtitlesPreferences = koinInject<app.marlboroadvance.mpvar.preferences.SubtitlesPreferences>()
      ...
      if (showFilePicker) {
          app.marlboroadvance.mpvar.ui.browser.dialogs.FilePickerDialog(
              isOpen = true,
      ...
      val subtitlesPreferencesForApiCheck = koinInject<app.marlboroadvance.mpvar.preferences.SubtitlesPreferences>()
    ...
    Sheets.AspectRatios -> {
      ...
      val customRatios =
        customRatiosSet.mapNotNull { str ->
          val parts = str.split("|")
          if (parts.size == 2) {
            app.marlboroadvance.mpvar.ui.player.controls.components.sheets.AspectRatio(
              label = parts[0],
      ...
      AspectRatioSheet(
        ...
        onSelectRatio = { ratio ->
          if (ratio < 0) {
            ...
            viewModel.changeVideoAspect(app.marlboroadvance.mpvar.ui.player.VideoAspect.Fit)
          } else {
